# Provenance: adapted from mattpocock/skills skills/engineering/wizard/template.sh
# (MIT License, Copyright (c) 2026 Matt Pocock) — integrated into Super-Skill V4.1.4.
# Library above the STAGES marker is identical to upstream; keep it that way.
#
#!/usr/bin/env bash
#
