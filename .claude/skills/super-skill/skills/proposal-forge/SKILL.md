...
This is the falsifiable gate that kills incremental ideas before CC burns dev cycles — and the enforcement point for constitution articles **C1** (hardest problem), **C3** (world-best & landable), and **C7** (ten× plan, approved before code — "未批准不写一行业务代码"): a proposal that survives the ten× gate is bold by construction. See [../../references/dev-constitution.md](../../references/dev-constitution.md).
